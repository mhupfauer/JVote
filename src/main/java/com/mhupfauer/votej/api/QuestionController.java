...
public class QuestionController {
    ...
    @PostMapping("/")
    public ResponseEntity<HttpStatus> newQuestion(@PathVariable(name = "ballot_id") Long bid, @RequestBody Map<String, Object> fields) {
    ...
    public ResponseEntity<HttpStatus> patchQuestion(@PathVariable(name = "ballot_id") Long bid, @PathVariable(name = "question_id") Long qid, @RequestBody Map<String, Object> fields) {
